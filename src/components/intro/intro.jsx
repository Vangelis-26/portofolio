            ...
            <section className="text-center">
               <div className="flex justify-center mb-8">
                  <div className="relative">
                     <div className="absolute -inset-2 bg-(--color-border)/20 rounded-3xl blur-xl"></div>
                     <div className="relative w-48 md:w-56 aspect-[903/1368] overflow-hidden rounded-2xl shadow-lg">
                        <Image
                           src="/photo.webp"
